...
%----------------------------------------------
% Advanced Headers and Footers Configuration
%----------------------------------------------
...
% Define custom line thickness and colors for headers/footers
\renewcommand{\headrulewidth}{0.8pt}
\renewcommand{\footrulewidth}{0.4pt}

% Custom colors for header/footer elements
\definecolor{headerblue}{RGB}{60, 60, 60}
\definecolor{footergray}{RGB}{0, 102, 204}
