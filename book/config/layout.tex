...
% Part entries in TOC
\renewcommand{\cftpartfont}{\Large\sffamily\bfseries\color{arlizblue}}
\renewcommand{\cftpartpagefont}{\Large\sffamily\bfseries\color{arlizblue}}
\renewcommand{\cftpartleader}{\cftdotfill{\cftpartdotsep}}
\renewcommand{\cftpartdotsep}{4.5}

% Chapter entries in TOC
\renewcommand{\cftchapfont}{\large\sffamily\bfseries\color{arliznavy}}
\renewcommand{\cftchappagefont}{\large\sffamily\bfseries\color{arliznavy}}
