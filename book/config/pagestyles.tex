...
\fancypagestyle{chapter}{
	...
	\fancyfoot[C]{%
		...
		\renewcommand{\footrule}{\hbox to\headwidth{\color{arlizlightblue}\leaders\hrule height \footrulewidth\hfill}}
...
\fancypagestyle{part}{%
	...
	% Footer rule
	\renewcommand{\footrule}{\hbox to\headwidth{\color{arlizblue}\leaders\hrule height \footrulewidth\hfill}}
}
